...
<html>
    ...
    <body>  
        <h1 class="card-header">Tabela dos Clientes</h1>
        <table class="table" style="padding: 15%; margin: 30px;">
            ...
            %>              
                <tr>
                    ...
                    <td>
                        <a href="editarCliente.jsp?id=<%=rs.getString("id") %>" style="text-decoration:none;"> 
                            <img src="https://pngimage.net/wp-content/uploads/2018/06/icono-modificar-png-5.png" class="img-fluid" style="width: 2%">
                        </a>
                        <a href="processoExcluir.jsp?table=1&id=<%=rs.getString("id") %>">
